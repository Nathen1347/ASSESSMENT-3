...
// const luigi = new Character('Luigi', 'human');
// luigi.getInfo()
//////////////////PROBLEM 2////////////////////
...
//CODE HERE
const fireSpitter = new Player('Fire Spitter', 'dragon', 5000, 5000)
fireSpitter.addSuperPower('spitting fire', 'fire blast', 'flamethower')
